...
print('''
\033[1;92m         WiFi_-_Catcher_-_By_-_Naimur9800         \033[0m
''')
...
class Companion:
    ...
    def __init__(self, interface, save_result=False, print_debug=False):
        ...
        self.sessions_dir = f'{user_home}/.Naimur/sessions/'
        self.pixiewps_dir = f'{user_home}/.Naimur/pixiewps/'
...
def usage():
    return """
OneShotPin 0.0.2 (c) 2017 rofl0r, modded by Naimur_B@B@
...
Advanced arguments:
    ...
    --vuln-list=<filename>   : Use custom file with vulnerable devices list ['naimur9800.txt']
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='OneShotPin 0.0.2 (c) 2017 rofl0r, modded by Naimur_B@B@',
    ...
    parser.add_argument(
        '--vuln-list',
        type=str,
        default=os.path.dirname(os.path.realpath(__file__)) + '/naimur9800.txt',
